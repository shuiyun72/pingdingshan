export default {
    ...
    mapDeviceTypeToIcon: {
        ...
        '三通@供水设施': './static/images/santong.png',
        '四通@供水设施': './static/images/sitong.png',
        '水表井@供水设施': './static/images/sitongjing.png',
        '压力表@供水设施': './static/images/yalibiao.png',
        '弯头@供水设施': './static/images/wantou.png'
    },
    dataTableId: {
        // 水质监测
        water: 10,
